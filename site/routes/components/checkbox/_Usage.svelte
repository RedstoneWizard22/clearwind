<script lang="ts">
	...
	import Switch from '$site/components/temp/Switch.svelte';
	...
	import Section from '$site/components/layout/Section.svelte';
	import SectionDemo from '$site/components/layout/SectionDemo.svelte';
